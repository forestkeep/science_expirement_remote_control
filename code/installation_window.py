...
class Ui_Installation(QtWidgets.QMainWindow):
    ...
    def setupUi(self, Installation, list_of_device):
        ...
        for device in self.list_of_device:
            self.verticalLayoutWidget[device] = (QtWidgets.QWidget(self.centralwidget))
            self.verticalLayoutWidget[device].setGeometry(QtCore.QRect(10+160*i, 0, 150, 320))
            self.verticalLayoutWidget[device].setObjectName("verticalLayoutWidget" + str(i))
            self.verticalLayoutWidget[device].setStyleSheet("background-color: rgb(255, 180, 180);")
            self.verticalLayout[device] = (QtWidgets.QVBoxLayout(self.verticalLayoutWidget[device]))
            self.verticalLayout[device].setContentsMargins(5, 0, 0, 0)
            self.verticalLayout[device].setObjectName("verticalLayout" + str(i))
            self.horizontalLayout[device] = (QtWidgets.QHBoxLayout())
            self.horizontalLayout[device].setObjectName("horizontalLayout_" + str(i))
            self.name_device[device] = (QtWidgets.QLabel(self.verticalLayoutWidget[device]))
            font = QtGui.QFont()
            ...
            self.number_device[device]= (QtWidgets.QLabel(self.verticalLayoutWidget[device]))
            ...
            self.verticalLayout[device].addLayout(self.horizontalLayout[device])
            self.label[device] = (QtWidgets.QLabel(self.verticalLayoutWidget[device]))
            ...
            self.change_device_button[device].setObjectName("change_device_button_" + str(i+1))
            self.verticalLayout[device].addWidget(self.change_device_button[device])
            print(self.change_device_button[device])
            i+=1
        

        self.pbar = QtWidgets.QProgressBar(self.centralwidget)
        self.pbar.setGeometry(QtCore.QRect(10, 440, 15+160*len(self.list_of_device), 20))
        self.pbar.setValue(0)
        self.start_button = QtWidgets.QPushButton(self.centralwidget)
        self.start_button.setGeometry(QtCore.QRect(30+160*len(self.list_of_device), 340, 221, 81))
        font = QtGui.QFont()
        ...
        self.pause_button.setGeometry(QtCore.QRect(30+160*len(self.list_of_device), 440, 101, 23))
        self.pause_button.setObjectName("pause_button")
        self.cancel_button = QtWidgets.QPushButton(self.centralwidget)
        self.cancel_button.setGeometry(QtCore.QRect(150+160*len(self.list_of_device), 440, 101, 23))
        self.cancel_button.setObjectName("cancel_button")
        self.gridLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(20+160*len(self.list_of_device), 0, 231, 321))
        ...
        self.schematic_installation = QtWidgets.QGraphicsView(self.gridLayoutWidget)
        ...
        self.log_text.setGeometry(QtCore.QRect(10, 320, 10+160*len(self.list_of_device), 110))
    ...
    def retranslateUi(self, Installation):
        ...
        i = 0
        for device in self.list_of_device:
            self.name_device[device].setText(_translate("Installation", device))
            self.number_device[device].setText(_translate("Installation", str(i+1)))
            self.label[device].setText(_translate("Installation", "TextLabel"))
            self.change_device_button[device].setText(_translate("Installation", "Изменить настройки"))
            i+=1
        ...
        self.save_installation_button.setText(_translate("Installation", "Сохранить установку"))
        self.add_device_button.setText(_translate("Installation", "Добавить прибор"))
