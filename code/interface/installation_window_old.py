...
class Ui_Installation(QtWidgets.QMainWindow):
    ...
    def setupUi(self, base_window, installation_class, class_of_devices):
        ...
        self.Layout_devices.setGeometry(QtCore.QRect(15, 0, self.N*160-10, 320))
        ...
        self.pbar.setGeometry(QtCore.QRect(10, 450, 15+160*self.N, 20))
        self.pbar.setValue(0)
        self.start_button = QtWidgets.QPushButton(self.centralwidget)
        self.start_button.setGeometry(QtCore.QRect(30+160*self.N, 345, 221, 100))
        font = QtGui.QFont()
        font.setPointSize(24)
        self.start_button.setFont(font)
        self.start_button.setObjectName("start_button")
        self.pause_button = QtWidgets.QPushButton(self.centralwidget)
        self.pause_button.setGeometry(QtCore.QRect(150+160*self.N, 450, 101, 23))
        ...
        self.label_state.setGeometry(QtCore.QRect(10, 470, 15+160*self.N, 20))
        self.label_state.setObjectName("label_state")

        self.verticalLayoutWidget_2 = QtWidgets.QWidget(base_window)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10+160*self.N, 30, 261, 150))
        ...
        self.way_save_text = QtWidgets.QLineEdit()
        ...
        self.debug_check = QtWidgets.QCheckBox("debug mode")
        self.debug_check.setFont(font)
        self.verticalLayout_2.addWidget(self.debug_check)
        # ================================================================

        self.log = QtWidgets.QTextEdit(self.centralwidget)
        self.log.setGeometry(QtCore.QRect(10, 345, 10+160*self.N, 100))
        self.log.setObjectName("log_text")
        self.log.setReadOnly(True)
        self.clear_log_button = QtWidgets.QPushButton(self.centralwidget)
        self.clear_log_button.setGeometry(QtCore.QRect(10, 325, 18, 18))
        icon = QtGui.QIcon()
