...
class ColorManager:
    def __init__(self, colors: List[str] = None):
        if colors is None:
            self._all_colors = [
                "rgba(71, 235, 235, 255)", "rgba(71, 235, 205, 255)", "rgba(71, 235, 175, 255)",
                "rgba(86, 71, 235, 255)", "rgba(116, 71, 235, 255)", "rgba(146, 71, 235, 255)",
                "rgba(175, 71, 235, 255)", "rgba(205, 71, 235, 255)", "rgba(235, 71, 235, 255)",
                "rgba(235, 71, 205, 255)", "rgba(235, 71, 175, 255)", "rgba(235, 71, 146, 255)",
                "rgba(235, 71, 116, 255)", "rgba(235, 71, 86, 255)", "rgba(235, 86, 71, 255)",
                "rgba(235, 106, 71, 255)", "rgba(235, 126, 71, 255)", "rgba(235, 146, 71, 255)"
            ]
        else:
