...
class saving_data:
    ...
    def __save_excell(self, output_file_path):
        ...
        try:
            ...
            logger.warning(
                f"Эксель файл не записан {output_file_path=} {self.input_file=}"
            )
...
def process_and_export(
    input_file_path, output_file_path, output_type, is_delete_buf_file
):
    save = saving_data()
    status = True
    try:
        output_file_path = save.save_data(
            input_file_path, output_file_path, output_type
        )
...
if __name__ == "__main__":
    save = saving_data()
    input_file = "buf_files/DS1104Z_1_2024-09-07 11-42-04.txt"
