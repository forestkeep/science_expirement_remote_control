...
class power_supply(base_device):
    def __init__(self, name, type_connection, installation_class) -> None:
            ...
            self.setting_window.sourse_enter.setStyleSheet(ready_style_border)
            ...
            self.setting_window.triger_enter.setStyleSheet(ready_style_border)
            ...
            self.setting_window.triger_enter.currentIndexChanged.connect(lambda: self._action_when_select_trigger())
            ...
            self.setting_window.sourse_enter.currentTextChanged.connect(lambda: self._is_correct_parameters())
    ...
    def show_setting_window(self, number_of_channel):
            ...
            self.setting_window.type_work_enter.setCurrentText(self.active_channel.dict_buf_parameters["type_of_work"])
            self.setting_window.type_step_enter.setCurrentText(self.active_channel.dict_buf_parameters["type_step"])
            self.setting_window.start_enter.setCurrentText(self.active_channel.dict_buf_parameters["low_limit"])
            self.setting_window.stop_enter.setCurrentText(self.active_channel.dict_buf_parameters["high_limit"])
            self.setting_window.step_enter.setCurrentText(self.active_channel.dict_buf_parameters["step"])
            self.setting_window.triger_enter.setCurrentText(self.active_channel.dict_buf_parameters["trigger"])
            self.setting_window.second_limit_enter.setCurrentText(self.active_channel.dict_buf_parameters["second_value"])
            ...
            if (self.active_channel.dict_buf_parameters["type_of_work"]== "Стабилизация напряжения"):
                self.setting_window.second_value_limit_label.setText("Ток не выше (А)")

            elif (self.active_channel.dict_buf_parameters["type_of_work"]== "Стабилизация тока"):
