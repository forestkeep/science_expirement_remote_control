...
class Ui_Set_relay(base_settings_window):
    ...
    def retranslateUi(self, Set_power_supply):
        ...
        self.hall1_meas.setText(_translate(
            "Set_power_supply", "Датчик холла 1"))
        self.hall2_meas.setText(_translate(
            "Set_power_supply", "Датчик холла 2"))
        self.hall3_meas.setText(_translate(
            "Set_power_supply", "Датчик холла 3"))
        self.hall4_meas.setText(_translate(
            "Set_power_supply", "Датчик холла 4"))
