...
class device_page(QtWidgets.QWidget):
    def __init__(self, device_class, installation_class, parent=None):
        ...
        for j in range(self.ind_channels):
            ...
            if self.ch_state[j] == state_ch.open:
                ...
                #lay_add_but = QtWidgets.QVBoxLayout()
                #lay_add_but.addWidget(self.add_ch_button[j+1])
                #lay_add_but.addItem(QtWidgets.QSpacerItem(15, 15, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding))
                #widget.setLayout(lay_add_but)
                #self.channelsLayout.addWidget(widget)
    ...
    def update_widgets(self):
        ...
        for i in reversed(range(self.channelsLayout.count())):
            #self.channelsLayout.removeItem(self.channelsLayout.itemAt(i))
